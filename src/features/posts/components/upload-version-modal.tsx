...
import { Loader2, ImageIcon, Layers, Upload } from 'lucide-react';
...
export function UploadVersionModal({ isOpen, onClose, postId, campaignId }: UploadVersionModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Enviar Artes Finalizadas">
      {isSuccess ? (
        ...
        <div className="bg-primary/5 border border-primary/20 rounded-2xl p-4 mb-2 text-center text-xs text-primary font-medium italic">
        ...
        <div className="space-y-2">
          ...
          <div className="relative group/file">
            ...
            />
            {feedPreview ? (
              <div className="relative w-full aspect-square rounded-xl overflow-hidden border-2 border-primary/30">
                <img src={feedPreview} className="w-full h-full object-cover" alt="Feed" />
              ...
              <div className="w-full bg-white/5 border-2 border-dashed border-white/10 group-hover/file:border-primary/50 group-hover/file:bg-primary/5 rounded-xl px-4 py-8 text-center transition-all">
        ...
        <div className="space-y-2">
          ...
          <div className="relative group/file">
            ...
            />
            {storiesPreview ? (
              <div className="relative w-full aspect-[9/16] max-h-[200px] rounded-xl overflow-hidden border-2 border-primary/30">
                <img src={storiesPreview} className="w-full h-full object-cover" alt="Stories" />
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover/file:opacity-100 transition-opacity">
                  <span className="text-white text-[10px] font-bold bg-black/60 px-3 py-1 rounded-full uppercase">Trocar Arte</span>
                </div>
              </div>
